      ...
      <Card className="p-6 flex items-center gap-4 border-2">
        <div className="relative">
          ...
          {avatarState === 'thinking' && (
            <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-primary/20 to-accent/20 animate-spin-slow pointer-events-none blur-sm" />
          )}
        </div>
        <div>
          <h2 className="text-2xl font-bold">Your AI Twin</h2>
